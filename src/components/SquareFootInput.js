...
const SquareFootInput = ({ calculate, handleLHWInputs, setTotalFootage, themeColor }) => {
  ...
  return (
    <div className="inputs">
      ...
      <input className={`sq-foot-button button ${themeColor}`} type="button" value="CALC SQ. FOOTAGE" onClick={calculate} />
    </div>
  )
}
